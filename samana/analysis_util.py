...
def quick_setup(lens_ID):
    ...
    if lens_ID == 'B1422':
    ...
    elif lens_ID == 'J0259_HST_475X':
        from samana.Data.j0259 import J0259_HST_F475X as data_class
        from samana.Model.j0259_model import J0259ModelEPLM3M4Shear as model_class
    elif lens_ID == 'J0607':
        ...
        from samana.Model.j0924_model import J0924ModelEPLM3M4Shear as model_class
    elif lens_ID == 'H1413':
