...
class _J0248ModelBase(ModelBase):
    ...
    def __init__(self, data_class, kde_sampler, shapelets_order):
        ...
        super(_J0248ModelBase, self).__init__(data_class, kde_sampler)
    ...
    def setup_source_light_model(self):
        ...
        kwargs_source_init = [
            {'amp': 0.023544785303811558, 'R_sersic': 6.595147609544372, 'n_sersic': 4.47510380669574,
...
class J0248ModelEPLM3M4Shear(_J0248ModelBase):
    ...
    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(J0248ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [
            {'theta_E': 0.801582922725, 'gamma': 2.2305061738549496, 'e1': -0.10172397525980102,
