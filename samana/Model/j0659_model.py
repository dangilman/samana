    ...
    def setup_lens_light_model(self):
        ...
        kwargs_lens_light_init = [
            ...
            {'amp': 185.9911238011588, 'R_sersic': 0.0647064660040841, 'n_sersic': 2.117934331728986,
             'center_x': 0.48086739997877176, 'center_y': 1.4976030071889535}
        ]
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [
            {'theta_E': 2.1605631755867893, 'gamma': 1.9560591845864295, 'e1': -0.037496027239971266,
             ...
             {'theta_E': 0.24869308897450168, 'center_x': 0.48086739997877176, 'center_y': 1.4976030071889535}
        ]
        ...
        kwargs_lens_sigma = [{'theta_E': 0.05, 'center_x': 0.1, 'center_y': 0.1, 'e1': 0.2, 'e2': 0.2, 'gamma': 0.1,
                             ...
                             {'gamma1': 0.1, 'gamma2': 0.1}, {'theta_E': 0.1, 'center_x': 0.025, 'center_y': 0.025}]
        ...
        kwargs_lower_lens = [
            ...
            {'theta_E': 0.2, 'center_x': star_x - 0.1, 'center_y': star_y - 0.1}]
        kwargs_upper_lens = [
            {'theta_E': 5.0, 'center_x': 10.0, 'center_y': 10.0, 'e1': 0.5, 'e2': 0.5, 'gamma': 3.5, 'a4_a': 0.1,
             'a3_a': 0.1, 'delta_phi_m3': np.pi / 6, 'delta_phi_m4': 10.0},
            {'gamma1': 0.5, 'gamma2': 0.5},
            {'theta_E': 0.8, 'center_x': star_x + 0.1, 'center_y': star_y + 0.1}]
