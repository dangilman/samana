...
class _J0259ModelBase(ModelBase):
    ...
    def __init__(self, data_class, kde_sampler, shapelets_order):
        ...
        super(_J0259ModelBase, self).__init__(data_class, kde_sampler)
    ...
    def setup_source_light_model(self):
        ...
        kwargs_source_init = [
            {'amp': 0.05491642729478453, 'R_sersic': 6.9093363724002455, 'n_sersic': 9.844143197166268,
             'e1': -0.14484172331047837, 'e2': -0.32012494521000967, 'center_x': -0.05179906391880345,
             'center_y': 0.012618365822868734}
        ]
...
class J0259ModelEPLM3M4Shear(_J0259ModelBase):
    ...
    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(J0259ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [
            {'theta_E': 0.7369527718657329, 'gamma': 2.1937521160887608, 'e1': -0.08050885101244437,
             'e2': 0.009287893139704151, 'center_x': -0.013250122099100866, 'center_y': 0.008078960001261536,
             'a3_a': 0.0, 'delta_phi_m3': 0.22987261028257142, 'a4_a': 0.0, 'delta_phi_m4': 1.8881239601300293},
            {'gamma1': 0.03504176304303244, 'gamma2': -0.05897384069865829, 'ra_0': 0.0, 'dec_0': 0.0}
        ]
