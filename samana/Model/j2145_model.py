...
class J2145ModelEPLM3M4ShearSatellite(_J2145):

    # satellite_x = -4.77
    # satellite_y = -0.1174
    satellite_x = 5.92448801
    satellite_y = -0.667
    def __init__(self, data_class, shapelets_order=None, shapelets_scale_factor=2.5 / 2):

        super(J2145ModelEPLM3M4ShearSatellite, self).__init__(data_class, shapelets_order, shapelets_scale_factor)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [
            {'theta_E': 0.998769587003212, 'gamma': 1.9744110382168731, 'e1': -0.017941674550855997,
             'e2': 0.043047979752150065, 'center_x': -0.18228132405929476, 'center_y': 0.20599853383689018, 'a3_a': 0.0,
             'a1_a': 0.0, 'delta_phi_m1': 0.01, 'delta_phi_m3': 0.47412736802809846, 'a4_a': 0.0, 'delta_phi_m4': 2.939320541612013},
            {'gamma1': 0.052049597314606864, 'gamma2': 0.14840243517340163, 'ra_0': 0.0, 'dec_0': 0.0},
            {'theta_E': 0.5, 'center_x': self.satellite_x, 'center_y': self.satellite_y}
        ]
        ...
        kwargs_upper_lens = [
            {'theta_E': 5.0, 'center_x': 10.0, 'center_y': 10.0, 'e1': 0.5, 'e2': 0.5, 'gamma': 2.4, 'a4_a': 0.1,
             'a1_a': 0.1, 'delta_phi_m1': np.pi,'a3_a': 0.1, 'delta_phi_m3': np.pi/6, 'delta_phi_m4': 10.0},
            {'gamma1': 0.5, 'gamma2': 0.5},
        {'theta_E': 2.0, 'center_x': self.satellite_x+0.3, 'center_y': self.satellite_y+0.3}]
        kwargs_lens_fixed, kwargs_lens_init = self.update_kwargs_fixed_macro(lens_model_list_macro, kwargs_lens_fixed,
                                                                             kwargs_lens_init, macromodel_samples_fixed)
        lens_model_params = [kwargs_lens_init, kwargs_lens_sigma, kwargs_lens_fixed, kwargs_lower_lens,
                             kwargs_upper_lens]
...
class J2145ModelEPLM3M4ShearTwoSatellite(_J2145):

    satellite_x1 = -4.77
    satellite_y1 = -0.1174
    satellite_x2 = 5.92448801
    satellite_y2 = -0.667
    def __init__(self, data_class, shapelets_order=None, shapelets_scale_factor=2.5 / 2):
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [
            {'theta_E': 0.998769587003212, 'gamma': 1.9744110382168731, 'e1': -0.017941674550855997,
             ...
             'a1_a': 0.0, 'delta_phi_m1': 0.01, 'delta_phi_m3': 0.47412736802809846, 'a4_a': 0.0, 'delta_phi_m4': 2.939320541612013},
            {'gamma1': 0.052049597314606864, 'gamma2': 0.14840243517340163, 'ra_0': 0.0, 'dec_0': 0.0},
            {'theta_E': 0.5, 'center_x': self.satellite_x1, 'center_y': self.satellite_y1},
            {'theta_E': 0.5, 'center_x': self.satellite_x2, 'center_y': self.satellite_y2}
        ]
        ...
        kwargs_upper_lens = [
            {'theta_E': 5.0, 'center_x': 10.0, 'center_y': 10.0, 'e1': 0.5, 'e2': 0.5, 'gamma': 2.4, 'a4_a': 0.1,
             'a1_a': 0.1, 'delta_phi_m1': np.pi,'a3_a': 0.1, 'delta_phi_m3': np.pi/6, 'delta_phi_m4': 10.0},
            {'gamma1': 0.5, 'gamma2': 0.5},
        {'theta_E': 2.0, 'center_x': self.satellite_x1+0.3, 'center_y': self.satellite_y1+0.3},
        {'theta_E': 0.0, 'center_x': self.satellite_x2-0.3, 'center_y': self.satellite_y2-0.3}]
        kwargs_lens_fixed, kwargs_lens_init = self.update_kwargs_fixed_macro(lens_model_list_macro, kwargs_lens_fixed,
                                                                             kwargs_lens_init, macromodel_samples_fixed)
        lens_model_params = [kwargs_lens_init, kwargs_lens_sigma, kwargs_lens_fixed, kwargs_lower_lens,
