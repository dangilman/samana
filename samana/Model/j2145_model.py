...
class _J2145(EPLModelBase):
    ...
    def setup_lens_light_model(self):
        ...
        kwargs_lens_light_init = [
            {'amp': 0.4063795423148451, 'R_sersic': 2.0, 'n_sersic': 4.0,
             'center_x': -0.29998901092131025, 'center_y': 0.07036309128461801}
        ]
...
class J2145_WIDEFIELD_ModelEPLM3M4ShearSatellite(_J2145):

    def __init__(self, data_class, shapelets_order=None, shapelets_scale_factor=2.5 / 2):

        super(J2145_WIDEFIELD_ModelEPLM3M4ShearSatellite, self).__init__(data_class, shapelets_order, shapelets_scale_factor)
    ...
    def setup_lens_light_model(self):
        ...
        sat_x2 = self._data.x_image[0] + self._data.sat2_x_wrt0
        sat_y2 = self._data.y_image[0] + self._data.sat2_y_wrt0
        lens_light_model_list = ['SERSIC', 'SERSIC', 'SERSIC']
        kwargs_lens_light_init = [
