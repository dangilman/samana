...
class _J2026ModelBase(EPLModelBase):
...
class J2026ModelEPLM3M4Shear(_J2026ModelBase):
...
class J2026ModelEPLM3M4Shear_Qgrad(J2026ModelEPLM3M4Shear):

    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):

        lens_model_list_macro = ['EPL_QGRAD_MULTIPOLE_M1M3M4', 'SHEAR']
        kwargs_lens_macro = [{'dq': 0.0, 'dphi': 0.0, 'theta_E': 0.7080359513151707, 'gamma': 2.0, 'e1': 0.44301405649940157,
                              'e2': -0.042982860335337526, 'center_x': -7.8816310197601e-08,
                              'center_y': -4.050045729301764e-08, 'a3_a': 0.0,
                              'a1_a': 0.0, 'delta_phi_m1': 0.0, 'delta_phi_m3': 0.0, 'a4_a': 0.0,
                              'delta_phi_m4': 0.0},
