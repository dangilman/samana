...
class J0924ModelEPLM3M4Shear(_J0924ModelBase):
    ...
    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(J0924ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
