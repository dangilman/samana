...
class _MG0414ModelBase(ModelBase):
    ...
    def __init__(self, data_class, kde_sampler, shapelets_order):
        ...
        super(_MG0414ModelBase, self).__init__(data_class, kde_sampler)
    ...
    def setup_source_light_model(self):
        ...
        kwargs_source_init = [{'amp': 15.2492488280051, 'R_sersic': 0.7248277235181109,
    ...
    def setup_lens_light_model(self):
        ...
        if add_uniform_light:
            ...
            kwargs_uniform_lower, kwargs_uniform_upper = self.add_uniform_lens_light(44.0, 4.0)
...
class MG0414ModelEPLM3M4Shear(_MG0414ModelBase):
    ...
    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(MG0414ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)

    @property
    def prior_lens(self):
        return [[0, 'gamma', 2.0, 0.1], [2, 'center_x', -0.61, 0.1], [2, 'center_y', 1.325, 0.1]]
