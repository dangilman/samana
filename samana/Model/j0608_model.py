...
class J0608ModelEPLM3M4Shear_Qgrad(J0608ModelEPLM3M4Shear):

    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):

        lens_model_list_macro = ['EPL_QGRAD_MULTIPOLE_M1M3M4', 'SHEAR']
        kwargs_lens_macro = [
            {'dq': 0.0, 'dphi': 0.0, 'theta_E': 0.6532820278185346, 'gamma': 1.9746894779636153, 'e1': -0.25524241780970597,
             'e2': 0.24885545694840164, 'center_x': -0.13394227096205186,
             'center_y': -0.02191325079999363, 'a3_a': 0.0, 'delta_phi_m3': -0.023559538941816876,
             'a1_a': 0.0, 'delta_phi_m1': 0.0,'a4_a': 0.0, 'delta_phi_m4': 0.0},
            {'gamma1': -0.06398351803681233, 'gamma2': 0.07871641065353437, 'ra_0': 0.0, 'dec_0': 0.0}
...
class J0608ModelEPLM3M4ShearSatellite_Qgrad(J0608ModelEPLM3M4ShearSatellite):
