...
class J2017ModelEPLM3M4Shear(_J2017ModelBase):
    ...
    def __init__(self, data_class, kde_sampler=None, shapelets_order=None):
        super(J2017ModelEPLM3M4Shear, self).__init__(data_class, kde_sampler, shapelets_order)
    ...
    def setup_lens_model(self, kwargs_lens_macro_init=None, macromodel_samples_fixed=None):
        ...
        kwargs_lens_macro = [
            {'theta_E': 0.522949906285526, 'gamma': 2.0730994551219784, 'e1': -0.12765399816937095,
             'e2': -0.10126183582400314, 'center_x': 0.042060772998393954, 'center_y': -0.09152100625874765,
             'a3_a': 0.0, 'delta_phi_m3': -0.22970593566866818, 'a4_a': 0.0, 'delta_phi_m4': 1.1402896090438979},
            {'gamma1': -0.13809797877727858, 'gamma2': -0.079057095874316, 'ra_0': 0.0, 'dec_0': 0.0}
        ]
