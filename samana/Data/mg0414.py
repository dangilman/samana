...
class _MG0414(ImagingDataBase):
    ...
    def __init__(self, x_image, y_image, magnifications, image_position_uncertainties, flux_uncertainties,
        ...
        if image_data_type == 'HST814W':
            ...
            from samana.Data.ImageData.mg0414_MIRI540W import psf_model, image_data, noise_map
        ...
        super(_MG0414, self).__init__(z_lens, z_source,
...
class MG014_MIRI(_MG0414):
    ...
    def __init__(self, supersample_factor=1):
        ...
        x_image = np.array([0.9026194, 1.03431555, 0.30406474, -1.04099969])
        y_image = np.array([-0.75854443, -0.36194475, 1.1853559, -0.46486672])
        ...
        super(MG014_MIRI, self).__init__(x_image,
                                     y_image,
                                     magnifications,
