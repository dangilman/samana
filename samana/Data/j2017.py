...
class _J2017(ImagingDataBase):
    ...
    def __init__(self, x_image, y_image, magnifications, image_position_uncertainties, flux_uncertainties,
        ...
        if image_data_type == 'HST814W':
            ...
            from samana.Data.ImageData.j2017_MIRI540W import psf_model, image_data, noise_map
            self._psf_estimate_init = psf_model
            self._psf_error_map_init = None
            self._image_data = image_data
            self._psf_supersampling_factor = 3
            self._deltaPix = 0.1109189450761549
            self._window_size = 2.8838925719800277
            self._ra_at_xy_0 = -0.814169704564101
            self._dec_at_xy_0 = 1.8696378982633144
            self._transform_pix2angle = np.array([[0.10322337, -0.04059493],
                                                  [-0.04059493, -0.10322337]])
        ...
        super(_J2017, self).__init__(z_lens, z_source,
...
class J2017_MIRI(_J2017):
    ...
    def __init__(self, supersample_factor=1):
        ...
        x_image = np.array([-0.42332786, 0.05147819, 0.44959781, 0.16225186])
        y_image = np.array([0.0245604, 0.46207431, 0.15912583, -0.68576054])
        ...
        super(J2017_MIRI, self).__init__(x_image,
                                     y_image,
                                     magnifications,
