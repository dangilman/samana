...
import numpy as np
from samana.Data.ImageData.psj0147_f814W import psf_model, psf_error_map, image_data

class _PSJ0147(ImagingDataBase):
    ...
    def __init__(self, x_image, y_image, magnifications, image_position_uncertainties, flux_uncertainties,
        ...
        super(_PSJ0147, self).__init__(z_lens, z_source,
    ...
    def kwargs_data(self):
        ...
        kwargs_data = {'background_rms': 0.0056578,
                       'exposure_time': 1348.0,
    ...
    def coordinate_properties(self):
        ...
        window_size = 6.0
        ra_at_xy_0 = 2.997399
        dec_at_xy_0 = -3.001339
        transform_pix2angle = np.array([[-3.99832025e-02,  1.78742397e-05],
       [ 1.78776082e-05,  3.99999860e-02]])
...
class PSJ0147_JWST(_PSJ0147):
    ...
    def __init__(self):
        ...
        """
        x_image = np.array([ 1.34636471,  0.17985224, -1.06632055, -0.16562942])
        y_image = np.array([ 0.95715542,  1.37402077,  1.27676234, -1.8573245 ])
        ...
        super(PSJ0147_JWST, self).__init__(x_image, y_image, magnifications, image_position_uncertainties, flux_uncertainties,
