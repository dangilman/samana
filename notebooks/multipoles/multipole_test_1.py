...
from samana.Data.Mocks.baseline_smooth_mock import BaselineSmoothMockMultipole1, BaselineSmoothMockModel
import os
import numpy as np
import sys
...
def main():
    ...
    output_path = output_path_base + '/multipole_test_mock_1/'
